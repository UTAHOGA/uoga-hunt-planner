...
function updateMapAppearance() {
  ...
  const isTerrainLike = ['terrain', 'outdoor', 'topo'].includes(basemapSelect.value);
...
// --- LEAFLET.GOOGLEMUTANT BASEMAPS ---
// 1. Define the clean outfitter JSON style to strip city clutter
const huntingStyle = [
  { "featureType": "poi.business", "stylers": [{ "visibility": "off" }] },
  { "featureType": "poi.medical", "stylers": [{ "visibility": "off" }] },
  { "featureType": "poi.school", "stylers": [{ "visibility": "off" }] },
  { "featureType": "transit", "stylers": [{ "visibility": "off" }] },
  { "featureType": "road", "elementType": "geometry", "stylers": [{ "lightness": 40 }, { "saturation": -60 }, { "weight": 1 }] },
  { "featureType": "road", "elementType": "labels.text.fill", "stylers": [{ "color": "#7a7a7a" }] },
  { "featureType": "water", "elementType": "geometry.fill", "stylers": [{ "color": "#9bbedf" }, { "visibility": "on" }] },
...
if (basemapSelect) {
  basemapSelect.value = 'terrain'; // Re-mapped to default to our new Google HD Topo
  updateMapAppearance();
  basemapSelect.addEventListener('change', () => {
    ...
    // Fallback to terrain if something breaks
    (basemaps[basemapSelect.value] || basemaps.terrain).addTo(map);
